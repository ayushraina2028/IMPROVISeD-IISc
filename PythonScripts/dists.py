...
def visualize_ca_distances_from_csv(csv_file, output_file):
    # Load the PDB files
    cmd.load("../Input/chain_A.pdb", "chain_A")
    cmd.load("../Input/chain_B.pdb", "chain_B")
...
visualize_ca_distances_from_csv("../Input/crosslinks_original.csv", "../DistanceBounds/crosslinks_satisfy.csv")

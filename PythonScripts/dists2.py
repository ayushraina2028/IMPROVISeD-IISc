...
def visualize_ca_distances_from_csv(csv_file, output_file):
    # Load the PDB files
    cmd.load("../Flipping/flip1.pdb", "chain_A")
    cmd.load("../Flipping/flip2.pdb", "chain_B")
...
visualize_ca_distances_from_csv("../Input/crosslinks_original.csv", "../DistanceBounds/crosslinks_satisfy_noflip.csv")
